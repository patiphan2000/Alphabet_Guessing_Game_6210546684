...
def play():
    ...
    if (choice):
        ...
        body += "</br></br>"
        body += '<span>'
        body += """<input type="submit" name="questioning[]" value="A" onclick="location.href='/play?answer=A'" style="margin-left: 5px"/>"""
        body += """<input type="submit" name="questioning[]" value="B" onclick="location.href='/play?answer=B'" style="margin-left: 5px"/>"""
        body += """<input type="submit" name="questioning[]" value="C" onclick="location.href='/play?answer=C'" style="margin-left: 5px"/>"""
        body += """<input type="submit" name="questioning[]" value="D" onclick="location.href='/play?answer=D'" style="margin-left: 5px"/>"""
        body += "</span>"
